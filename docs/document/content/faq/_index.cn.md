我是一个初学者，看了一下文档，如果要是有一个代码用例就好了，在本地执行一次，文档里面详细说明了配置文件的使用，希望能有一个完整的pom，完整的配置文件，spring
，spirng boot都行，复制粘贴到本地就能用了。源码里有一个生成代码的例子，但是依赖包太复杂了，弄了半天也没有在本地执行成功。很失落，可能是自己太菜了，希望作者能对菜鸟友好一些，提供一些基本的使用演示用例。
+++
pre = "<b>8. </b>"
title = "FAQ"
weight = 8
